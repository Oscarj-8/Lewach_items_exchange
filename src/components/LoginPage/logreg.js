  ...
  return(
    ...
    <section className="container-form container-form-sign-in">
      <form action="" className="sign-up-form">
        <h1>Sign In</h1>
        <div className="container-social">
          <a href="#" className="social"><img src={logo}/></a>
        </div>
    ...
    <section className="overlay-container">
      <div className="overlay">
        <div className="overlay-panel overlay-sign-in">
          ...
          <button className="button overlay__button-ghost overlay__button-sign-in">Sign in</button>
        </div>
        <div className="overlay-panel overlay-sign-up">
          ...
          <button className="button overlay__button-ghost overlay__button-sign-up">Register</button>
        </div>
      </div>
    </section>
  </section>
